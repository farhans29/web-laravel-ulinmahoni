        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <nav class="mb-8">
                <ol class="flex items-center space-x-2 text-gray-500">
                    ...
                    <li><a href="{{ route('properties') }}" class="hover:text-gray-700">Properties</a></li>
                    <li><span class="mx-2">/</span></li>
            ...
            <div class="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($property['attributes']['room_facilities'] as $facility)
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            @foreach($property['attributes']['rules'] as $rule)
                                <div class="flex items-center text-gray-600">
                                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        @foreach($property['attributes']['amenities'] as $amenity)
