    ...
    <div class="swiper property-swiper">
        <div class="swiper-wrapper mb-8">
            ...
            <div class="swiper-slide">
                <a href="{{ route('hotels.show', ['id' => $hotel['id']]) }}" class="block hover:shadow-lg transition-shadow duration-300">
                    <div class="property-card bg-white rounded-lg shadow-md overflow-hidden">
                        <div class="relative">
                            ...
                            <div class="absolute bottom-2 left-2">
                                <span class="bg-teal-600 text-white text-xs px-2 py-1 rounded-full">{{ $hotel['type'] }}</span>
                            </div>
                        </div>

                        <div class="p-4">
                            <h3 class="font-medium text-gray-800 mb-1">{{ $hotel['name'] }}</h3>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center">
                                        <p class="font-bold text-gray-800">
                                            Rp{{ number_format($hotel['price']['discounted'], 0, ',', '.') }} <span class="text-xs font-normal">/bulan</span>
                                        </p>
                                    </div>
                                </div>
